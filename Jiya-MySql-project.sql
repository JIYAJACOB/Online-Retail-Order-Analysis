...
select A.ORDER_ID,B.CUSTOMER_ID,B.CUSTOMER_FNAME,B.CUSTOMER_LNAME,SUM(C.PRODUCT_QUANTITY) AS TOTAL_QUANTITY_OF_PRODUCTS
FROM order_header AS A JOIN online_customer AS B
ON A.CUSTOMER_ID=B.CUSTOMER_ID
left JOIN order_items AS C ON A.ORDER_ID=C.ORDER_ID
WHERE A.ORDER_ID>10030
AND B.CUSTOMER_FNAME LIKE 'A%'
